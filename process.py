"""
FROM — https://github.com/cydivision/climbnet

This Program Takes an Image Path and a Model Path,
Generates a Segmentation Mask of Bouldering Holds and Volumes
    (See README.md on Git Page for Specifics)
    Holds — Actual Bouldering Holds (Plastic)
    Volumes — Additional Structures (Volumetric Objects: Wood, Plastic Etc.)
"""

# TODO: RETURN ONLY MASK AND DON'T DIRECTLY DISPLAY IMAGE...
